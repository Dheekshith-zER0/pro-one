...
def get_translation_data():
    ...
    translations = {
        ...
        "hi": {  # Hindi
            ...
            "welcome_title": "फ़िशिंग और यूआरएल चेकर में आपका स्वागत ہے", 
    ...
    # 🛑 CORRECTED: REMOVE the three lines that copied 'en' over 'te', 'bn', 'ur'
    # The language dictionaries are now fully defined above.
...
if st.session_state.lang_code is None:
    ...
    # 2. MAIN APP: LANGUAGE IS SET (t is loaded correctly)
